...
import 'package:popular_movie/src/Network/api_popular.dart';
...
import 'package:popular_movie/src/views/card_popular.dart';
...
class _PopularScreen extends State<PopularScreen> {
  ...
  Widget _listPopularMovies(List<dynamic>? data, Function? _upDate) {
